      ...
      <div class="row text-start">
        ...
        <div class="col-md-2 mb-4">
          ...
          <ul class="list-unstyled">
            <li>
              <a style="color: var(--text-tertiary);" href="#" class="text-decoration-none">About Us</a>
            </li>
            <li>
              <a style="color: var(--text-tertiary);" href="#" class="text-decoration-none">Movies</a>
            </li>
            <li>
              <a style="color: var(--text-tertiary);" href="#" class="text-decoration-none">Series</a>
            </li>
          </ul>
        </div>
        <div class="col-md-3 mb-4">
          ...
          <ul class="list-unstyled">
            ...
            <li>
              <a style="color: var(--text-tertiary);" href="#" class="text-decoration-none">Contact Us</a>
            </li>
            <li>
