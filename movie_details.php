  ...
  <body style="background-color: var(--bg-primary); color: var(--text-primary)">
    ...
    <main class="container" style="padding-top: 100px">
      ...
      <div class="rating-review mb-4">
        <h5>
          <i class="bi bi-star-fill" style="color: var(--gold)"></i> <?php echo htmlspecialchars($movie['rating']); ?>/10 IMDb
          Rating
        </h5>
      </div>

      <div class="action-buttons d-flex gap-3 flex-wrap mb-5">
<a href="add_to_cart.php?movie_id=<?php echo $movie['movie_id']; ?>" class="btn btn-outline-light px-4 py-2">
  <i class="bi bi-cart-plus me-2"></i>Add to Cart
        ...
        >
        <a
          href="watch_movie.php?movie_id=<?php echo $movie['movie_id']; ?>"
